          ...
          child: ListTile(
            ...
            subtitle: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.business_rounded, size: 12, color: AppColors.iconMuted),
                    const SizedBox(width: 6),
                    Text('Tòa nhà: ${ch.tenToaNha}', style: TextStyle(color: AppColors.textMuted, fontSize: 12)),
                    const Spacer(),
                    Icon(Icons.layers_rounded, size: 12, color: AppColors.iconMuted),
                    const SizedBox(width: 4),
                    Text('Tầng: ${ch.tang}', style: TextStyle(color: AppColors.textMuted, fontSize: 12)),
                  ],
                ),
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 6),
                    Text('Loại: ${ch.tenLoaiCanHo}', style: TextStyle(color: AppColors.textMuted, fontSize: 12)),
                  ],
                ),
              ],
            ),
